      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {learnings.map((item, index) => (
            <GlassCard 
              key={index}
              className="group hover:shadow-[0_0_40px_hsl(var(--cyan)/0.3)] transition-all duration-500 overflow-hidden relative"
            >
              ...
              <div className="flex items-center gap-4 relative z-10 p-6">
                ...
                <div className="flex-shrink-0 w-28 h-52 md:w-32 md:h-60 rounded-2xl overflow-hidden bg-muted/30">
                  <video 
                    src={item.video}
