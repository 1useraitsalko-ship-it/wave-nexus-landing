  ...
  return (
    <section className="relative py-24 bg-gradient-wave">
      <div className="max-w-[1240px] mx-auto px-6 md:px-8 text-center space-y-12">
        ...
        <div className="inline-block animate-pulse scale-[2] md:scale-[3]">
          <div className="px-12 py-6 rounded-full border-4 border-cyan bg-gradient-to-br from-cyan/30 to-cyan/10 shadow-[0_0_60px_hsl(var(--cyan)/0.6)] text-cyan text-2xl md:text-4xl font-bold animate-glow">
