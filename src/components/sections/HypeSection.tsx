  ...
  return (
    <section className="relative py-24 bg-gradient-wave">
      <div className="max-w-[1240px] mx-auto px-6 md:px-8 text-center space-y-12">
        ...
        <div className="pt-16">
          <h3 className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-violet via-blue-400 via-cyan via-teal-400 to-green-400 bg-clip-text text-transparent animate-gradient-wave">
            Сейчас вторая волна
          </h3>
        </div>
      </div>
